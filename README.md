...
```yaml
Name:     Abdimajid Abdirahman Ibrahim
Role:     Full-Stack Developer
Company:  Astaan Tech
Location: Somalia / Mogadishu
Email:    abdimajidabdirahman35@gmail.com
```

**What I Do:**
- 📱 Build mobile apps for iOS & Android with React Native
- 🌐 Build web dashboards with Next.js & TypeScript
- ⚙️ Design & build REST APIs with Laravel & Node.js
...
[![trophy](https://github-profile-trophy.vercel.app/?username=abdimajid123&theme=darkhub&no-frame=true&column=7&margin-w=10)](https://github.com/abdimajid123)
...
![footer](https://capsule-render.vercel.app/api?type=waving&color=gradient&colors=7b2ff7,f107a3&height=100&section=footer)
